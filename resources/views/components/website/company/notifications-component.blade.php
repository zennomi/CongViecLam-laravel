<li>
    <div class="notification-icon relative pointer position-relative">
        ...
        @if (companyUnreadNotifications() > 0)
            ...
            <div class="notification-list">
                <ul>
                    @if (companyNotifications()->count() > 0)
                        @foreach (companyNotifications() as $noti)
                            ...
                            @if ($noti->type == 'App\Notifications\Website\Company\JobCreatedNotification' ||
                                $noti->type == 'App\Notifications\Website\Company\JobEditedNotification' ||
                                $noti->type == 'App\Notifications\Website\Company\JobDeletedNotification')
                                <li>
                                    <a onclick="readSingleNotification('{{ $noti->data['url'] }}', '{{ $noti->id }}')"
                                        href="javascript:void(0)" class="d-flex">
                                        <div class="notification-thumb">
