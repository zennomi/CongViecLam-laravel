...
(function (factory) {
    ...
    Plugin.prototype = {
        ...
        _initListeners: function () {
            ...
            this.countryInput.on("blur" + this.ns, function () {
                if (
                    ...
                    that.getSelectedCountryData().name
                ) {
        ...
        _handleEnterKey: function () {
            var currentCountry = this.countryList
                .children(".highlight")
                .first();
        ...
        getSelectedCountryData: function () {
            ...
            var countryCode = this.selectedFlagInner
                .attr("class")
                .split(" ")[1];
